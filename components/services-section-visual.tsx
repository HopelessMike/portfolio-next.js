...
const services = [
  {
    ...
    clickable: true,
    chatMessage:
      "Sono interessato ai servizi di sviluppo AI. Puoi parlarmi delle tue soluzioni di machine learning e AI?",
  },
  {
    icon: Workflow,
    title: "Automazione Processi",
    subtitle: "Flussi di Lavoro Ottimizzati",
    color: "from-secondary to-secondary/60",
    size: "medium",
    position: "top-right",
    clickable: true,
    chatMessage:
      "Ho bisogno di aiuto con l'automazione dei processi. Che soluzioni di ottimizzazione del flusso di lavoro offri?",
  },
  {
    icon: BarChart3,
    title: "Analisi Dati",
    subtitle: "Insights Azionabili",
    color: "from-accent to-accent/60",
    size: "medium",
    position: "middle-left",
    clickable: true,
    chatMessage: "Sto cercando soluzioni di analisi dati. Come puoi aiutarmi a estrarre insights dai miei dati?",
  },
  {
    icon: MessageSquare,
    title: "Sviluppo Chatbot",
    ...
    clickable: true,
    chatMessage:
      "Sono interessato ai servizi di sviluppo chatbot. Puoi dirmi di più sulle tue soluzioni di AI conversazionale?",
  },
  {
    icon: Code,
    ...
    clickable: true,
    chatMessage:
      "Ho bisogno di sviluppo software personalizzato. Che soluzioni su misura puoi creare per la mia azienda?",
  },
  {
    icon: Database,
    title: "Gestione Dati",
    subtitle: "Sistemi Efficienti",
    color: "from-accent to-primary",
    size: "small",
    position: "bottom-right",
    clickable: true,
    chatMessage:
      "Ho bisogno di aiuto con le soluzioni di gestione dati. Che servizi offri per sistemi dati efficienti?",
  },
]
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-6xl font-heading font-bold mb-6">
            SOLUZIONI PER TRASFORMARE IL TUO <span className="text-gradient italic">BUSINESS</span>
          </h2>
