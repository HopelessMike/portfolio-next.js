...
const skills = [
  {
    ...
    description: "Costruzione di sistemi intelligenti con machine learning e deep learning",
  },
  {
    name: "Automazione Processi",
    icon: <Workflow className="w-8 h-8 text-secondary" />,
    description: "Ottimizzazione di flussi di lavoro e processi aziendali con l'automazione",
  },
  {
    name: "Analisi Dati",
    icon: <LineChart className="w-8 h-8 text-accent" />,
    description: "Estrazione di insights da dataset complessi per guidare le decisioni",
  },
  {
    name: "Sviluppo Chatbot",
    icon: <Bot className="w-8 h-8 text-primary" />,
    description: "Costruzione di interfacce AI conversazionali per il coinvolgimento dei clienti",
  },
]
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h3 className="text-xl font-heading font-bold mb-6 text-center">
            Stack <span className="text-gradient">Tecnologico</span>
          </h3>
